...
class Student:public Person
{
	 ...
	 string get_class(int i) const; //return list_classes[i]
         void set_level(int lvl); //lvl-->level
         void set_num_grades( int num); //num->num_grades, allocate memory to *grades
	 void set_num_classes(int num); //num->num_classes, allocate memory to *list_classes
         void set_grade(int i, double grd); //grd --> grades[i]
	 void set_class(int i, string cls); //cls --> list_classes[i]
